...
Route::middleware(['auth', 'verified', 'onboarded', 'not-pending-del'])->group(function () {
    ...
    Route::post('/transactions/{txId}/stop-cadence',   [TransactionController::class, 'stopCadence'])->name('transactions.stop-cadence');
    ...
    Route::patch('/memory/contacts/{id}',         [MemoryController::class, 'updateContact'])->name('memory.contacts.update');
    ...
    Route::patch('/memory/rules/{id}',            [MemoryController::class, 'updateRule'])->name('memory.rules.update');
    ...
    Route::post('/workers/{id}/memory/groups/{gid}/renew-now',        [AssetGroupController::class, 'renewGroupNow'])->name('workers.memory.groups.renew-now');
    Route::post('/workers/{id}/memory/groups/{gid}/fix-dates',        [AssetGroupController::class, 'fixDates'])->name('workers.memory.groups.fix-dates');
