...
class OnboardingController extends Controller
{
    ...
    public function showAvaOnShift(Request $request)
    {
        ...
        $groupedStages   = \App\Platform\Services\PipelineStageService::groupedStages($rawStages);
    ...
    public function saveAvaPersona(\Illuminate\Http\Request $request)
    {
        ...
        if (!$deployment) {
            ...
            DB::table('deployment_billing')->insert([
                ...
                'trial_transactions_limit'  => \App\Platform\Services\PlatformDefaults::totalTrialLimitFor('ava'),
                'fast_track_allocation'     => \App\Platform\Services\PlatformDefaults::fastTrackAllocationFor('ava'),
