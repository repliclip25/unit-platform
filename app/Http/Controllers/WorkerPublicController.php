        ...
        $workers = [
            'ava' => [
                ...
                'faq' => [
                    ...
                    ['q' => 'Can I prove what happened, for compliance or a client dispute?', 'a' => 'Yes. Every closed renewal gets a ' . config('app.name') . '-branded archive PDF, every draft, every reminder, every approval decision, with a QR code linking to a signed, downloadable copy for a full year.'],
