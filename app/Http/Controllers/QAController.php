...
Pre-loaded by UNITELO at transaction start. Jobs read from `\$input->memory[...]` — no DB calls during pipeline.
...
Pipeline config is editable per deployment in the UNITELO QA Studio without redeploying.

---

_Generated by UNITELO Platform · {$date}_
MD;
