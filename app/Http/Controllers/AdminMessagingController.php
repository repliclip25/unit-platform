...
class AdminMessagingController extends Controller
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            [
                ...
                'audience'          => 'all',
                'worker_slug'       => null,
                'topic'             => 'How UNITELO workers handle coordination vs. decision-making',
            ...
            [
                ...
                'day_offset'        => 60,
                'trigger_state'     => null,
                'subject'           => 'What\'s coming to UNITELO',
    ...
    public static function influencerDefaults(): array
    {
        return [
            ...
            [
                ...
                'day_offset'        => null,
                'trigger_state'     => null,
                'subject'           => 'Welcome to UNITELO — you\'ve got extra trial transactions',
            ...
            [
                ...
                'day_offset'        => null,
                'trigger_state'     => null,
                'subject'           => 'Someone just joined UNITELO through your link',
                'body'              => "Hi {name},\n\nYour first referral just signed up for UNITELO.\n\nWhen they start a paid subscription, you'll get a $25 credit on your account — applied automatically.\n\nFranklin at UNITELO",
                'from_name'         => 'Franklin at UNITELO',
                'sort_order'        => 46,
            ],
            [
    ...
    public static function transactionalDefaults(): array
    {
        return [
            ...
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Action required: payment failed on your UNITELO account',
                'body'        => "Hi {name},\n\nA payment on your UNITELO account failed and your worker processing has been paused.\n\nPlease update your payment method to resume:\n\n{app_url}/billing\n\nIf this was a mistake or you need help, reply to this email.\n\nFranklin at UNITELO",
                'from_name'   => 'Franklin at UNITELO',
                'sort_order'  => 2,
            ],
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Your UNITELO worker subscription has been canceled',
            ...
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Your UNITELO account is active again',
            ...
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'You\'re subscribed to UNITELO',
            ...
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Gmail connected — UNITELO Universe is now monitoring your inbox',
            ...
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Your UNITELO Universe password was changed',
                'body'        => "Hi {name},\n\nYour UNITELO Universe password was just changed.\n\nIf this was you, no action is needed.\n\nIf you didn't do this, reset your password immediately:\n{app_url}/forgot-password\n\nFranklin at UNITELO",
                'from_name'   => 'UNITELO Universe',
                'sort_order'  => 23,
            ],
            [
                'key'         => 'daily_summary',
            ...
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Your UNITELO account has been deleted',
                'body'        => "Hi {name},\n\nYour UNITELO account and all associated data have been permanently deleted.\n\nIf you ever want to return, you're welcome to sign up again at any time:\n{app_url}/register\n\nFranklin at UNITELO",
                'from_name'   => 'Franklin at UNITELO',
                'sort_order'  => 26,
            ],
        ];
    ...
    public function rewrite(Request $request, int $id)
    {
        ...
        $system = "You are an expert SaaS email copywriter. You write short, plain-text emails that feel personal and direct — no fluff, no corporate speak, no bullet-point overload. The sender is Franklin, founder of UNITELO, a platform for deploying AI automation workers.\n\nYour rewrites should:\n- Feel like they came from a real person who understands the reader's problem\n- Use the reader's language where possible (informed by the feedback sources below)\n- Be shorter than the original\n- Have a single clear action or question\n- Never use subject lines with exclamation marks\n- End simply with: Franklin at UNITELO";
