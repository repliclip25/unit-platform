...
class AdminMessagingController extends Controller
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            // ── Legacy day-offset AVA templates (kept for existing tenants, replaced above) ──
            [
                'key'               => 'ava_day3_no_gmail',
                'sequence'          => 'worker_onboarding',
                'audience'          => 'worker_specific',
                'worker_slug'       => 'ava',
                'label'             => '[Legacy] AVA — Day 3 — No Gmail connected',
                'description'       => 'Legacy day-offset version. Replaced by ava_abandon_no_gmail (hour-based).',
            ...
            [
                ...
                'audience'          => 'worker_specific',
                'worker_slug'       => 'ava',
                'label'             => '[Legacy] AVA — Day 3 — Connected, no emails processed',
                'description'       => 'Legacy day-offset version. Replaced by ava_abandon_no_clients (hour-based).',
            ...
            [
                ...
                'audience'          => 'worker_specific',
                'worker_slug'       => 'ava',
                'label'             => '[Legacy] AVA — Day 7 — Deployed but no activity',
                'description'       => 'Legacy day-offset version. Replaced by ava_abandon_no_fasttrack (hour-based).',
            ...
            [
                ...
                'audience'          => 'all',
                'worker_slug'       => null,
                'topic'             => 'How UNITELO AI workers handle coordination vs. decision-making',
            ...
            [
                ...
                'day_offset'        => 60,
                'trigger_state'     => null,
                'subject'           => 'What\'s coming to UNITELO AI',
    ...
    public static function influencerDefaults(): array
    {
        return [
            ...
            [
                ...
                'day_offset'        => null,
                'trigger_state'     => null,
                'subject'           => 'Welcome to UNITELO AI — you\'ve got extra trial transactions',
            ...
            [
                ...
                'day_offset'        => null,
                'trigger_state'     => null,
                'subject'           => 'Someone just joined UNITELO AI through your link',
                'body'              => "Hi {name},\n\nYour first referral just signed up for UNITELO AI.\n\nWhen they start a paid subscription, you'll get a $25 credit on your account — applied automatically.\n\nFranklin at UNITELO AI",
                'from_name'         => 'Franklin at UNITELO AI',
                'sort_order'        => 46,
            ],
            [
    ...
    public static function transactionalDefaults(): array
    {
        return [
            ...
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Action required: payment failed on your UNITELO AI account',
                'body'        => "Hi {name},\n\nA payment on your UNITELO AI account failed and your worker processing has been paused.\n\nPlease update your payment method to resume:\n\n{app_url}/billing\n\nIf this was a mistake or you need help, reply to this email.\n\nFranklin at UNITELO AI",
                'from_name'   => 'Franklin at UNITELO AI',
                'sort_order'  => 2,
            ],
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Your UNITELO AI worker subscription has been canceled',
            ...
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Your UNITELO AI account is active again',
            ...
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'You\'re subscribed to UNITELO AI',
            ...
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Gmail connected — UNITELO AI is now monitoring your inbox',
            ...
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Your UNITELO AI password was changed',
                'body'        => "Hi {name},\n\nYour UNITELO AI password was just changed.\n\nIf this was you, no action is needed.\n\nIf you didn't do this, reset your password immediately:\n{app_url}/forgot-password\n\nFranklin at UNITELO AI",
                'from_name'   => 'UNITELO AI',
                'sort_order'  => 23,
            ],
            [
                ...
                'audience'    => 'all',
                'worker_slug' => null,
                'label'       => '[Retired] AVA Daily Summary',
                'description' => 'Replaced by weekly_summary. Kept for historical records — not sent.',
                'trigger_condition' => 'retired',
                'day_offset'  => null,
                'trigger_state' => null,
            ...
            [
                ...
                'description' => 'Monday morning digest of what Ava accomplished in the past 7 days. Only sends if there was at least 1 transaction. No Claude generation — DB-computed stats only.',
            ...
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Your UNITELO AI account is scheduled for deletion',
                'body'        => "Hi {name},\n\nWe've received your request to delete your UNITELO AI account.\n\nYour account will be permanently deleted on {deletion_date}. Until then, everything is still accessible and you can cancel the deletion from your profile settings.\n\nIf you change your mind:\n{app_url}/settings/profile\n\nFranklin at UNITELO AI",
                'from_name'   => 'Franklin at UNITELO AI',
                'sort_order'  => 25,
            ],
            [
                'key'         => 'gmail_token_expired',
                'sequence'    => 'operational',
                'audience'    => 'all',
                'worker_slug' => null,
                'label'       => 'Gmail Disconnected — Reconnect Required',
                'description' => 'Sent when a Gmail OAuth token expires or is revoked. AVA goes blind until reconnected.',
                'trigger_condition' => 'scheduled: daily token check',
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Action needed — reconnect your Gmail inbox',
                'body'        => "Hi {name},\n\nYour Gmail connection for {gmail_address} has been disconnected — AVA is no longer monitoring that inbox.\n\nThis usually happens when Gmail revokes access after a password change or security event.\n\nTo reconnect (takes 2 minutes):\n{app_url}/workers\n\nOpen your worker → Connect tab → reconnect the inbox.\n\nFranklin at UNITELO AI",
                'from_name'   => 'Franklin at UNITELO AI',
                'sort_order'  => 27,
            ],
            [
                ...
                'day_offset'  => null,
                'trigger_state' => null,
                'subject'     => 'Your UNITELO AI account has been deleted',
                'body'        => "Hi {name},\n\nYour UNITELO AI account and all associated data have been permanently deleted.\n\nIf you ever want to return, you're welcome to sign up again at any time:\n{app_url}/register\n\nFranklin at UNITELO AI",
                'from_name'   => 'Franklin at UNITELO AI',
                'sort_order'  => 26,
            ],
        ];
    ...
    public function store(Request $request)
    {
        ...
        DB::table('platform_email_templates')->insert([
            ...
            'day_offset'        => $data['day_offset'] ?? null,
    ...
    public function rewrite(Request $request, int $id)
    {
        ...
        $system = "You are an expert SaaS email copywriter. You write short, plain-text emails that feel personal and direct — no fluff, no corporate speak, no bullet-point overload. The sender is Franklin, founder of UNITELO AI, a platform for deploying AI automation workers.\n\nYour rewrites should:\n- Feel like they came from a real person who understands the reader's problem\n- Use the reader's language where possible (informed by the feedback sources below)\n- Be shorter than the original\n- Have a single clear action or question\n- Never use subject lines with exclamation marks\n- End simply with: Franklin at UNITELO AI";
