...
class ArchiveEvidenceJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $html = $this->styles();
        $html .= '<div class="hd">'
            . '<div class="hd-logo"><div class="hd-logo-unit">' . $esc(config('app.name')) . '</div><div class="hd-logo-worker">AVA</div></div>'
            . '<div class="hd-meta">'
        ...
        $html .= '<div class="ft">This record is durable proof of a ' . $esc(config('app.name')) . '-coordinated renewal. Re-download at any time via the QR code above or the link it resolves to.</div>';
