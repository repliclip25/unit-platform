...
<title>Confirm password — UNITELO</title>
...
<div class="au-wrap">
  <div class="au-card">
    <div class="au-h1">Confirm your password</div>
    <div class="au-sub">This is a secure area. Please confirm your password to continue.</div>
    ...
    <form method="POST" action="{{ route('password.confirm') }}">
      ...
      <button type="submit" class="au-submit">Confirm & Continue</button>
    </form>
  </div>
</div>
