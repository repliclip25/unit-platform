...
<body class="text-white font-sans antialiased min-h-screen flex flex-col">
    ...
    <nav class="flex items-center justify-between px-8 py-5 border-b border-white/5 max-w-7xl mx-auto w-full">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('register') }}" class="text-sm font-bold px-5 py-2.5 rounded-lg text-gray-900 transition" class="ac-bg">
                Get Started
            </a>
        </div>
    </nav>
    ...
    <div class="flex-1 flex items-center px-8 py-16 max-w-7xl mx-auto w-full gap-16">
        ...
        <div class="flex-1 max-w-xl">
            ...
            <h1 class="text-5xl md:text-6xl font-black leading-[1.05] mb-5">
                ...
                <br><span class="ac-text">Get Work Done.</span>
            </h1>
            ...
            <div class="flex gap-3 mb-6">
                ...
                <a href="{{ route('register') }}" class="px-6 py-3 rounded-xl text-sm font-bold text-gray-900 whitespace-nowrap" class="ac-bg">
                    Join the Waitlist
                </a>
            </div>
        ...
        <div class="hidden lg:block relative flex-1 max-w-md">
            <div class="flex flex-col gap-4">
                <div class="glass border border-white/10 rounded-2xl px-5 py-4 float" class="ac-border-left">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-lg flex items-center justify-center font-bold text-xs shrink-0" class="ac-on-soft-md">RC</div>
                        <div class="flex-1">
                ...
                <div class="glass border border-white/10 rounded-2xl px-5 py-4 float-1 ml-8" class="ac-border-left">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-lg flex items-center justify-center font-bold text-xs shrink-0" class="ac-on-soft-md">TC</div>
                        <div class="flex-1">
                ...
                <div class="glass border border-white/10 rounded-2xl px-5 py-4 float-2" class="ac-border-left">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-lg flex items-center justify-center font-bold text-xs shrink-0" class="ac-on-soft-md">CO</div>
                        <div class="flex-1">
                ...
                <div class="glass border border-white/10 rounded-2xl px-5 py-4 float-3 ml-8" class="ac-border-left">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-lg flex items-center justify-center font-bold text-xs shrink-0" class="ac-on-soft-md">CP</div>
                        <div class="flex-1">
            ...
            <div class="absolute -bottom-6 right-0 glass border border-white/10 rounded-lg px-3 py-1.5 text-xs tracking-widest" class="ac-text">
