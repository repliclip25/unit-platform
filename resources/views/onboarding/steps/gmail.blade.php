...
@php
    $credLabel      = $credentialInfo['label'] ?? 'Gmail';
    $credHint       = $credentialInfo['hint'] ?? 'NUX delivers finished drafts to this inbox for your review.';
    $authorizeRoute = $credentialInfo['authorize_route'] ?? null;
@endphp

<div class="mb-8">
    <h1 class="text-2xl font-black text-white mb-2">Connect your delivery inbox</h1>
...
<div class="rounded-xl px-5 py-6 mb-6 text-center"
    ...
    <p class="text-white font-semibold mb-1">Link your Gmail</p>
    <p class="text-sm mb-6" style="color:var(--text-muted)">
        NUX will send finished drafts here — one email per repurposed post, ready to copy and publish.
    </p>
