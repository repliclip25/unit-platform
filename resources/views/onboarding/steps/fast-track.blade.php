...
<div x-data="{ success: false }" @ft-pipeline-done.window="success = !$event.detail.failed">
    ...
    <div x-show="!success" class="mb-6">
        <h1 class="text-2xl font-black text-white mb-2 leading-snug">Ava is working...</h1>
        <p class="text-gray-400 text-sm">Here's everything happening behind the scenes.</p>
    </div>

    {{-- ── SUCCESS CARD — appears above the pipeline when done ── --}}
    <div x-show="success" x-cloak
        ...
        <div class="rounded-2xl border border-green-500/20 bg-green-500/5 px-6 py-5 mb-4">
            <div class="flex items-start gap-4">
                ...
                <div>
                    <p class="text-white font-black text-lg leading-snug mb-1">Ava completed her first assignment.</p>
