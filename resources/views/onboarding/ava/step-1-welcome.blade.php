...
.ob-hero-img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center top;transform:scale(.88);transform-origin:center top}
.ob-hero-fade{
...
@media(max-width:1024px){
  ...
  .ob-hero{
    min-height:400px;
    /* image takes up ~40% of space, scaled back for headroom above the text */
  }
  .ob-hero-fade{
    /* On mobile: fade from bottom, not from left */
    background:linear-gradient(to top,#fff 0%,#fff 32%,rgba(255,255,255,.85) 48%,rgba(255,255,255,.3) 65%,transparent 82%);
  }
  .ob-hero-content{
    position:relative;z-index:2;
