    ...
    <aside id="sidebar" class="fixed lg:static inset-y-0 left-0 z-40 w-64 flex flex-col transition-transform -translate-x-full lg:translate-x-0">
        ...
        <nav class="flex-1 px-3 py-4 overflow-y-auto space-y-5">
            ...
            <div>
                ...
                <a href="{{ route('app.transactions') }}" class="{{ $navLink(request()->routeIs('app.transactions*') || request()->routeIs('app.workers.transactions*')) }}" style="{{ $navStyle(request()->routeIs('app.transactions*') || request()->routeIs('app.workers.transactions*')) }}">
            ...
            <div>
                ...
                <a href="{{ route('admin.self-learn') }}" class="{{ $navLink(request()->routeIs('admin.self-learn*')) }}" style="{{ $navStyle(request()->routeIs('admin.self-learn*')) }}">
                ...
                <a href="{{ route('admin.reviews') }}" class="{{ $navLink(request()->routeIs('admin.reviews*')) }}" style="{{ $navStyle(request()->routeIs('admin.reviews*')) }}">
