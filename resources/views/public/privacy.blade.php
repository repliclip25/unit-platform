...
@section('description', 'How UNITELO collects, uses, and protects your data.')
...
<div class="w pub-body">
  ...
  <ul>
    <li>To operate and improve the UNITELO platform and worker pipelines</li>
