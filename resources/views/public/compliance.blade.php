...
<section class="about-cta">
  <div class="w">
    <div class="about-cta-inner">
      ...
      <h2>AVA handles renewals for insurance brokers too.</h2>
      <p>If your team manages license and policy renewals for a single agency rather than multiple clients, see how AVA fits an <a href="{{ route('insurance') }}" class="cta-link">insurance brokerage workflow</a>.</p>
