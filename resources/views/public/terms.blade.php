...
@section('description', 'Terms and conditions for using the UNITELO platform.')
...
<div class="w pub-body">
  ...
  <p>These Terms of Use ("Terms") govern your access to and use of the UNITELO platform operated by UNITELO ("we," "us," or "our"). By creating an account or using the platform, you agree to these Terms.</p>

  <h2>1. Use of the Platform</h2>
  <p>UNITELO provides AI-powered worker automation for compliance and license renewal operations. You may use the platform only for lawful business purposes. You may not:</p>
  <ul>
    ...
    <li>Use UNITELO workers to generate and send emails without human review (our workers require your approval before sending)</li>
  ...
  <p>UNITELO workers use AI (Claude by Anthropic) to generate draft content. You acknowledge that:</p>
  <ul>
    <li>AI-generated drafts require your review before use</li>
    <li>UNITELO is not liable for errors in AI-generated content that you approve and use</li>
  ...
  <p>You may use worker output (drafted emails, renewal notices, compliance reports) for your internal business operations. You may not resell, redistribute, or sublicense UNITELO output as a standalone product.</p>
