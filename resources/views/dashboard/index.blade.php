        ...
        <div>
          ...
          <div class="dc-worker-card">
              <div class="dc-wc-head">
                  ...
                  <a href="{{ route('workers.show', $dep->worker_slug) }}" class="dc-wc-open">Open →</a>
              </div>
              ...
              <div class="dc-wc-footer">
                  <a href="{{ route('workers.show', $dep->worker_slug) }}#fast-track" class="dc-wc-fast-track">Fast Track →</a>
