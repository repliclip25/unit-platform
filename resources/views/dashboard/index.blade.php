      ...
      <div class="dc-grid">
        ...
        <div>
          ...
          @php
              ...
              $deskHref    = $dep->worker_slug === 'ava' ? route('desk.ava') : route('workers.overview', $dep->worker_slug);
          @endphp
          <div class="dc-worker-card">
              <div class="dc-wc-head">
                  ...
                  <div style="display:flex;gap:6px;flex-shrink:0">
                      <a href="{{ route('workers.billing', $dep->worker_slug) }}" class="dc-wc-open">Billing</a>
              ...
              <div class="dc-wc-footer">
                  <a href="{{ route('workers.fast-track.page', $dep->worker_slug) }}" class="dc-wc-fast-track">Fast Track →</a>
          ...
          <div class="dc-empty-worker">
              ...
              <a href="{{ url('/workers') }}" class="dc-refer-btn">Deploy a Worker →</a>
          </div>
          @endforelse
