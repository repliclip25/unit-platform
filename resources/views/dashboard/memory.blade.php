...
.mem-select,.mem-input,.mem-textarea{width:100%;border-radius:9px;padding:9px 12px;font-size:12.5px;background:var(--db-card);border:1px solid var(--db-border);color:var(--db-text);font-family:inherit}
.mem-select:focus,.mem-input:focus,.mem-textarea:focus{outline:none;border-color:var(--db-invert-bg)}
.mem-file-label{display:inline-block;padding:9px 14px;border-radius:9px;border:1px solid var(--db-border);background:var(--db-card);color:var(--db-text-muted);font-size:12.5px;cursor:pointer}
...
.mem-btn-secondary{padding:8px 14px;border-radius:9px;border:1px solid var(--db-border);background:var(--db-card);color:var(--db-text-muted);font-size:12px;font-weight:600;cursor:pointer;font-family:inherit;text-decoration:none;display:inline-block}
...
.mem-group-chip{font-size:11px;padding:4px 9px;border-radius:8px;background:var(--db-card);color:var(--db-text-muted);display:flex;align-items:center;gap:5px}
