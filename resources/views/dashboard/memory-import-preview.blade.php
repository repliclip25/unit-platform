...
<title>Import Preview — UNITELO</title>
...
$backRoute   = isset($dep_id) ? route('app.workers.memory', $dep_id) : route('app.memory');
$commitRoute = isset($dep_id) ? route('app.workers.memory.import.commit', $dep_id) : route('app.memory.import.commit');
$sidebarLinks = [
  ['Memory',       'M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18', route('app.workers.memory','ava'), true],
      ...
      <div class="ip-card">
        <div class="ip-card-head">
          <div>
            ...
            <div class="ip-tpl-link">Need the template? <a href="{{ route('app.memory.import.template', $type) }}">Download {{ $type }}_import_template.csv</a></div>
          </div>
