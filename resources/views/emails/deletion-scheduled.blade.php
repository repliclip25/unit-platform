@php $emailTitle = 'Account deletion scheduled — '.config('app.name'); @endphp
...
<p>Hi {{ $name }}, we received a request to permanently delete your {{ config('app.name') }} account.</p>
...
@include('emails.partials.footer', ['footerNote' => "You're receiving this because a deletion was requested on your ".config('app.name')." account."])
