@php $emailTitle = 'Your '.config('app.name').' account has been deleted'; @endphp
@include('emails.partials.header')

<h1>Your account has been permanently deleted</h1>
<p>Hi {{ $name }}, your {{ config('app.name') }} account associated with <strong>{{ $email }}</strong> has been permanently deleted.</p>
...
@include('emails.partials.footer', ['footerNote' => "You're receiving this final email because your ".config('app.name')." account was deleted."])
