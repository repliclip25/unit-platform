...
<p>She scales the same way to agreements and closes the loop after completion: see <a href="{$this->pageUrl('ava', 'assets/contracts/renewal-tracking')}">Contract Renewal Tracking Software</a>, or <a href="{$this->pageUrl('ava', 'scheduling/renewal-calendar')}">Renewal Calendar &amp; Scheduling Software</a>. See how she connects each renewal to the right contact in <a href="{$this->pageUrl('ava', 'ownership/renewal-ownership-responsible-contacts')}">Renewal Ownership &amp; Responsible Contact Tracking</a>, and how the required human decision point fits into that same lifecycle in <a href="{$this->pageUrl('ava', 'approval/renewal-approval-workflow')}">Renewal Approval Workflow</a>.</p>
